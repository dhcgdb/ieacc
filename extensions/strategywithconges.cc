...
namespace nfd {
    namespace fw {
        ...
        NFD_LOG_INIT(BestRouteStrategy2WithConges);
        NFD_REGISTER_STRATEGY(BestRouteStrategy2WithConges);

        const time::milliseconds BestRouteStrategy2WithConges::RETX_SUPPRESSION_INITIAL(10);
        const time::milliseconds BestRouteStrategy2WithConges::RETX_SUPPRESSION_MAX(250);

        BestRouteStrategy2WithConges::BestRouteStrategy2WithConges(Forwarder& forwarder, const Name& name)
            : Strategy(forwarder)
        ...
        const Name& BestRouteStrategy2WithConges::getStrategyName()
        {
        ...
        void BestRouteStrategy2WithConges::afterReceiveInterest(const FaceEndpoint& ingress, const Interest& interest,
        ...
        void BestRouteStrategy2WithConges::afterReceiveNack(const FaceEndpoint& ingress, const lp::Nack& nack,
                                                            const shared_ptr<pit::Entry>& pitEntry)
        {
