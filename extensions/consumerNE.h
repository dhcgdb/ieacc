...
namespace ns3 {
    namespace ndn {
        ...
        class TransParam2Py1 : Ns3AIRL<DDPGParam, DDPGAct> {
        public:
            TransParam2Py1(uint16_t id);
            void GetActFromRLModule(DDPGAct*);
            void SendParam2RLModule(DDPGParam*);
            friend ConsumerNE;
        };

        class ConsumerNE : public ConsumerWindow {
        public:
        ...
        private:
            ...
            DDPGAct action;
            std::unique_ptr<TransParam2Py1> transclass;
            double alpha;

            friend void cwndChangeWDCallback(ConsumerNE*);
        };
    }
}
#endif
