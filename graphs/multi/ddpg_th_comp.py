...
file11 = '/root/ndn/proj-sep/log/multiport/dqn-c0.log'
file12 = '/root/ndn/proj-sep/log/multiport/dqn-c1.log'
x1, y1 = [], []
...
file21 = '/root/ndn/proj-sep/log/multiport/dqnbn-c0.log'
file22 = '/root/ndn/proj-sep/log/multiport/dqnbn-c1.log'
x2, y2 = [], []
...
file31 = '/root/ndn/proj-sep/log/multiport/ddpgbn-c0.log'
file32 = '/root/ndn/proj-sep/log/multiport/ddpgbn-c1.log'
x3, y3 = [], []
...
f1, = plt.plot(x1, y1, color='red', label='DQN', ls='-.')
f2, = plt.plot(x2, y2, color='#1A6FDF', label='DQNBN-W', ls=':')
f3, = plt.plot(x3, y3, color='#37AD6B', label='DDPGBN', ls='dashed')  #B177DE
...
plt.legend(handles=[f1,f2,f3, f4,f5],
           labels=['DQN','DQNBN-W','DDPG-BN', 'DDPGBN-W','DQNBN'],
           loc='lower right')
#plt.ylim((3,10))
#ax.legend()
#plt.grid(axis="y")
