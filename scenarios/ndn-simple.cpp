...
namespace ns3 {
    ...
    main(int argc, char* argv[])
  {
    ...
    Config::SetDefault("ns3::QueueBase::MaxSize", StringValue("32p"));
    ...
    ndn::StrategyChoiceHelper::Install(nodes.Get(1), "/prefix", "/localhost/nfd/strategy/best-route2-conges/%FD%01");
    ...
    //ndn::AppHelper interhelper("ns3::ndn::AppInter");
    //interhelper.SetPrefix("/prefix");
    //interhelper.Install(nodes.Get(1));
