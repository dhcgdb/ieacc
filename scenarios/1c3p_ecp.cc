...
namespace ns3 {
    int main(int argc, char* argv[])
    {
        ...
        ndn::StrategyChoiceHelper::Install(n3, "/ustc", "/localhost/nfd/strategy/best-route2-conges-ecp/%FD%01");
        ...
        consumerHelper0.SetAttribute("CcAlgorithm", EnumValue(ndn::CCType::ECP));
        ...
        consumerHelper0.SetAttribute("Log2File", StringValue("/root/ndn/proj-sep/log/reexp/ecp-c0-" + nrun + ".log"));
        ...
        consumerHelper1.SetAttribute("CcAlgorithm", EnumValue(ndn::CCType::ECP));
        ...
        consumerHelper1.SetAttribute("Log2File", StringValue("/root/ndn/proj-sep/log/reexp/ecp-c1-82-" + nrun + ".log"));
        ...
        consumerHelper2.SetAttribute("CcAlgorithm", EnumValue(ndn::CCType::ECP));
        ...
        consumerHelper2.SetAttribute("Log2File", StringValue("/root/ndn/proj-sep/log/multiport/ecp-c2.log"));
