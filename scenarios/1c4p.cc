...
namespace ns3 {
    int main(int argc, char* argv[])
    {
        ...
        consumerHelper0.SetPrefix("/ustc");
        ...
        consumerHelper0.SetAttribute("LogMask", IntegerValue(LOG_DATA ));//| LOG_NACK | LOG_TIMEOUT | LOG_LEARNING));
        consumerHelper0.SetAttribute("ShmID", IntegerValue(1024));
        consumerHelper0.SetAttribute("RandomPrefix", IntegerValue(3));
