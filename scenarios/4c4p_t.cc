...
namespace ns3 {
    int main(int argc, char* argv[])
    {
        ...
        consumerHelper0.SetAttribute("LogMask", IntegerValue(LOG_DATA));
        ...
        consumerHelper1.SetAttribute("LogMask", IntegerValue(LOG_DATA));
        ...
        consumerHelper2.SetAttribute("LogMask", IntegerValue(LOG_DATA));
        ...
        consumerHelper3.SetAttribute("LogMask", IntegerValue(LOG_DATA));
