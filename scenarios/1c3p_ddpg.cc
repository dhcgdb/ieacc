...
namespace ns3 {
    int main(int argc, char* argv[])
    {
        ...
        consumerHelper0.SetAttribute("Log2File", StringValue("/root/ndn/proj-sep/log/reexp/ddpg-c0-" + nrun + ".log"));
        ...
        consumerHelper1.SetAttribute("Log2File", StringValue("/root/ndn/proj-sep/log/reexp/ddpg-c1-64-" + nrun + ".log"));
        ...
        consumerHelper2.SetAttribute("Log2File", StringValue("/root/ndn/proj-sep/log/multiport/ddpg-c2.log"));
